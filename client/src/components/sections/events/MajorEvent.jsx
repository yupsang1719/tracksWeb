    ...
    <>
      <div className="cursor-pointer max-w-5xl mx-auto bg-[#0d2d45] rounded-lg shadow-lg overflow-hidden flex flex-col md:flex-row hover:scale-[1.01] transition">
        ...
        <div className="p-6 md:w-1/2 flex flex-col justify-between">
          ...
          🎟️ <span className="font-bold">0</span> Early Bird Tickets Left!<br />
          🎟️ <span className="font-bold">Limited</span> Standard Tickets Left!<br />
          ⏳ Offer ends in <CountdownTimer deadline="2025-08-15T23:59:59" /> Or When All Booked
          </div>
